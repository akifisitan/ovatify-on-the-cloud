...
from recommendation_service.models import CoreModel
...
class User(CoreModel):
    ...
    friends = models.ManyToManyField(
        "self", through="Friend", symmetrical=True, through_fields=("user", "friend")
    )
...
class SuggestionNotification(CoreModel):
    ...
    suggester = models.ForeignKey(
        User, related_name="notification_suggester", on_delete=models.CASCADE
    )
    song = models.ForeignKey(Song, on_delete=models.CASCADE)
